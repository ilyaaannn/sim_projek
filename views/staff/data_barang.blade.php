...
<head>
    ...
    <title>Data Barang - SIBIMA+</title>
...
<body>
    ...
    <nav class="navbar-custom">
        ...
        <div class="page-title">daa barang</div>
    ...
    <div class="main-content">
        <div class="content-header">
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    <input type="text" class="form-control" id="searchKode" placeholder="Masukkan Kode Barang">
                </div>
                <div class="col-md-4">
                    <input type="text" class="form-control" id="searchNama" placeholder="Nama Barang">
                </div>
                <div class="col-md-4">
            ...
            <table id="dataBarangTable" class="table table-bordered">
                <thead>
                    <tr>
                        <th>NO</th>
                        <th>Kode Barang</th>
