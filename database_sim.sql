...
INSERT INTO tbl_kategori (nama_kategori, deskripsi, created_at, updated_at) VALUES
('Elektronik', 'kualitas tiada tanding', NOW(), NOW()),
('Pakaian', 'bahan berkualitas sangat bagus', NOW(), NOW()),
('Peralatan Rumah', 'memenuhi perlengkapan dirumah anda', NOW(), NOW()),
('Aksesoris', 'bikin kamu jauh lebih menarik', NOW(), NOW()),
('Makanan & Minuman', 'kebutuhan hidup', NOW(), NOW());
...
('1001','Kipas Angin', 'Kipas angin berkecepatan tinggi', 1, 20, 250000, 'img/kipas.jpg', 'active', NOW(), NOW()),
('1002','Kemeja Polos', 'Kemeja formal bahan katun', 2, 35, 150000, 'img/kemeja.jpg', 'active', NOW(), NOW()),
('1003','Panci Stainless', 'Panci ukuran 24cm anti karat', 3, 15, 180000, 'img/panci.jpg', 'active', NOW(), NOW()),
('1004','Gelang Aesthetic', 'Gelang handmade korea style', 4, 50, 50000, 'img/gelang.jpg', 'active', NOW(), NOW()),
('1005','Kopi Arabica', 'Kopi bubuk arabica premium 500gr', 5, 40, 70000, 'img/kopi.jpg', 'active', NOW(), NOW());
...
INSERT INTO tbl_transaksi_barang (id_transb, id_barang, tipe, kuantiti, stok_sebelum, stok_sesudah, desc_tb, user_id, created_at, updated_at) VALUES
(101, 1001, 'masuk', 10, 20, 30, 'Restock barang masuk', 13, NOW(), NOW()),
(102, 1002, 'masuk', 20, 35, 55, 'Stok pakaian baru', 14, NOW(), NOW()),
(103, 1003, 'keluar', 5, 15, 10, 'Barang keluar untuk order', 13, NOW(), NOW()),
(104, 1004, 'keluar', 3, 50, 47, 'Digunakan sebagai sample', 14, NOW(), NOW()),
(105, 1005, 'masuk', 15, 40, 55, 'Stok kopi baru datang', 13, NOW(), NOW());
...
(10001, 15, 'pending', 320000, 'jl.sudirman', 'bagus', NOW(), NOW()),
(10002, 16, 'proses', 150000, 'jl.hangtuah', 'bagus', NOW(), NOW()),
(10003, 17, 'selesai', 450000, 'jl.kayangan', 'bagus', NOW(), NOW()),
(10004, 15, 'pending', 70000, 'jl.pramuka', 'bagus', NOW(), NOW()),
(10005, 16, 'batal', 0, 'jl.bantan', 'bagus', NOW(), NOW());
...
(100001, 10001, 1001, 1, 1, 250000, 250000, NOW(), NOW()),
(100002, 10001, 1005, 5, 1, 70000, 70000, NOW(), NOW()),
(100003, 10002, 1002, 2, 1, 150000, 150000, NOW(), NOW()),
(100004, 10003, 1003, 3, 2, 180000, 360000, NOW(), NOW()),
(100005, 10004, 1005, 5, 1, 70000, 70000, NOW(), NOW());
